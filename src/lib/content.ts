...
const defaultContent: SiteContent = {
  ...
  properties: [
    ...
    { id: '6053860', title: 'Bastelraum zu vermieten!', type: 'mieten', category: 'Werkstatt / Hobby', price: 'CHF 120', priceDetail: 'Bruttomiete / Monat', location: 'Bürglen TG', address: 'Säntisstrasse 45, 8575 Bürglen TG', rooms: null, area: 14.1, floor: 'Untergeschoss', available: '01.05.2026', yearBuilt: 2008, objectNumber: '1366..601', description: 'Bastelraum ca. 14.10 m² im UG. Stromanschluss und Lavabo vorhanden. Lift im Gebäude.\n\nBesichtigung: Herr Semi Harun 076 455 74 70.', features: ['Stromanschluss', 'Lavabo vorhanden', 'Lift im Gebäude', 'Zentrale Lage'], images: ['https://images.unsplash.com/photo-1558618666-fcd25c85f82e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80', 'https://images.unsplash.com/photo-1513694203232-719a280e022f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'], agent: { name: 'Priska Brülisauer', role: 'Administration', image: 'https://rbimmobilien.ch/userfiles/Priska%20Br%C3%BClisauer%20(Website).jpg', phone: '+41 71 626 01 24', email: 'p.bruelisauer@rbimmobilien.ch' } },
