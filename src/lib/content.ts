...
const defaultContent: SiteContent = {
  ...
  teamMembers: [
    { id: '1', name: 'Mara Schönholzer', role: 'Inhaberin | Geschäftsführerin', qualifications: ['eidg. dipl. Immobilientreuhänderin', 'Immobilienbewirtschafterin mit eidg. FA'], phone: '+41 71 626 01 23', mobile: '+41 79 966 00 24', email: 'm.schoenholzer@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Mara_Schoenholzer.jpg' },
    { id: '2', name: 'René Bock', role: 'Mitglied des Verwaltungsrates', qualifications: ['lic. iur. HSG'], phone: '+41 71 626 01 40', email: 'r.bock@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Rene_Bock.jpg' },
    { id: '3', name: 'Matthias Bichsel', role: 'Immobilienbewirtschafter', qualifications: [], phone: '+41 71 626 01 10', mobile: '+41 79 858 87 79', email: 'm.bichsel@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Matthias_Bichsel.jpg' },
    { id: '4', name: 'Vivian Keller', role: 'Immobilienbewirtschafterin', qualifications: ['mit eidg. Fachausweis'], phone: '+41 71 626 01 16', mobile: '+41 79 281 00 20', email: 'v.keller@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Vivian_Keller.jpg' },
    { id: '5', name: 'Michelle Suter', role: 'Buchhaltung', qualifications: [], phone: '+41 71 626 01 20', email: 'm.suter@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Michelle_Suter.jpg' },
    { id: '6', name: 'Vanessa Rahming', role: 'Buchhaltung', qualifications: [], phone: '+41 71 626 01 25', email: 'v.rahming@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Vanessa_Rahming.jpg' },
    { id: '7', name: 'Priska Brülisauer', role: 'Administration', qualifications: [], phone: '+41 71 626 01 24', email: 'p.bruelisauer@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Priska_Bruelisauer.jpg' },
    { id: '8', name: 'Verena Meier', role: 'Administration', qualifications: [], phone: '+41 71 626 01 22', email: 'v.meier@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Verena_Meier.jpg' },
    { id: '9', name: 'Manuel Kohler', role: 'Informatik', qualifications: [], phone: '+41 71 620 10 60', email: 'm.kohler@rbimmobilien.ch', image: 'https://rbimmobilien.ch/img/team/Manuel_Kohler.jpg' },
  ],
